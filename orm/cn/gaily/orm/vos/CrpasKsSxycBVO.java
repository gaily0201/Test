...
/**
 * <p>Title: CrpasKsSxycBVO</P>
 * <p>Description: </p>
 * @author xiaoh
 * @version 1.0
 * @since 
 */
@Table(tableName="crpas_ks_sxyc_b")
public class CrpasKsSxycBVO {
	/**
	* PK_KS_SXYC_B 子表主键
	*/
	@Column(columnName="pk_ks_sxyc_b",dataType="char",dataLength=20,nullAble="N",comment="子表主键")
	private String PK_KS_SXYC_B = "pk_ks_sxyc_b";
	/**
	* VROWNO 行号
	*/
	...
	*/
	...
	/**
	* getPk_ks_sxyc_b(void) 
	*/
	public String getPk_ks_sxyc_b(){
		return this.PK_KS_SXYC_B;
	}
	/**
	*setPk_ks_sxyc_b(java.lang.String)
	*/
	public void setPk_ks_sxyc_b(String pk_ks_sxyc_b){
		this.PK_KS_SXYC_B=pk_ks_sxyc_b;
	}
	/**
	* getVrowno(void) 
	*/
