...
/**
 * <p>Title: CrpasKsBgrBVO</P>
 * <p>Description: </p>
 * @author xiaoh
 * @version 1.0
 * @since 
 */
@Table(tableName="crpas_ks_bgr_b")
public class CrpasKsBgrBVO {
	/**
	* PK_KS_BGR_B 子表主键
	*/
	@Column(columnName="pk_ks_bgr_b",dataType="char",dataLength=20,nullAble="N",comment="子表主键")
	private String PK_KS_BGR_B = "pk_ks_bgr_b";
	/**
	* VROWNO 行号
	*/
	...
	*/
	...
	/**
	* V_DWFZZJZRR 单位犯罪直接负责人
	*/
	@Column(columnName="v_dwfzzjzrr",dataType="varchar",dataLength=200,nullAble="Y",comment="单位犯罪直接负责人")
	...
	* V_JSFLYZYY 接受法律援助原因
	*/
	@Column(columnName="v_jsflyzyy",dataType="varchar",dataLength=20,nullAble="Y",comment="接受法律援助原因")
	...
	* getPk_ks_bgr_b(void) 
	*/
	public String getPk_ks_bgr_b(){
		return this.PK_KS_BGR_B;
	}
	/**
	*setPk_ks_bgr_b(java.lang.String)
	*/
	public void setPk_ks_bgr_b(String pk_ks_bgr_b){
		this.PK_KS_BGR_B=pk_ks_bgr_b;
	}
	/**
	* getVrowno(void) 
	*/
