...
/**
 * <p>Title: CrpasKsDzqkBVO</P>
 * <p>Description: </p>
 * @author xiaoh
 * @version 1.0
 * @since 
 */
@Table(tableName="crpas_ks_dzqk_b")
public class CrpasKsDzqkBVO {
	/**
	* PK_KS_DZQK_B 子表主键
	*/
	@Column(columnName="pk_ks_dzqk_b",dataType="char",dataLength=20,nullAble="N",comment="子表主键")
	private String PK_KS_DZQK_B = "pk_ks_dzqk_b";
	/**
	* VROWNO 行号
	*/
	...
	* C_BGR 被告人id
	*/
	@Column(columnName="c_bgr",dataType="varchar",dataLength=20,nullAble="Y",comment="被告人id")
	...
	* V_XGWZYY 宣告无罪原因
	*/
	@Column(columnName="v_xgwzyy",dataType="varchar",dataLength=200,nullAble="Y",comment="宣告无罪原因")
	private String V_XGWZYY = "v_xgwzyy";
	/**
	* V_BFXSZRYY 不负刑事责任原因
	*/
	@Column(columnName="v_bfxszryy",dataType="varchar",dataLength=200,nullAble="Y",comment="不负刑事责任原因")
	...
	* V_DCFJX 单处附加刑
	*/
	@Column(columnName="v_dcfjx",dataType="varchar",dataLength=200,nullAble="Y",comment="单处附加刑")
	private String V_DCFJX = "v_dcfjx";
	/**
	* V_BCFJX 并处附加刑
	*/
	@Column(columnName="v_bcfjx",dataType="varchar",dataLength=200,nullAble="Y",comment="并处附加刑")
	...
	* V_FDXYXCX 法定刑以下处刑
	*/
	@Column(columnName="v_fdxyxcx",dataType="varchar",dataLength=200,nullAble="Y",comment="法定刑以下处刑")
	private String V_FDXYXCX = "v_fdxyxcx";
	/**
	* V_HXSPLXJG 后续审判量刑结果
	*/
	@Column(columnName="v_hxsplxjg",dataType="varchar",dataLength=200,nullAble="Y",comment="后续审判量刑结果")
	...
	*/
	...
	/**
	* getPk_ks_dzqk_b(void) 
	*/
	public String getPk_ks_dzqk_b(){
		return this.PK_KS_DZQK_B;
	}
	/**
	*setPk_ks_dzqk_b(java.lang.String)
	*/
	public void setPk_ks_dzqk_b(String pk_ks_dzqk_b){
		this.PK_KS_DZQK_B=pk_ks_dzqk_b;
	}
	/**
	* getVrowno(void) 
	*/
