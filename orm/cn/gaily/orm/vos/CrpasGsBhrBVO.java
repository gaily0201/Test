...
/**
 * <p>Title: CrpasGsBhrBVO</P>
 * <p>Description: </p>
 * @author xiaoh
 * @version 1.0
 * @since 
 */
@Table(tableName="crpas_gs_bhr_b")
public class CrpasGsBhrBVO {
	/**
	* VROWNO 行号
	*/
	...
	* C_BHR 被害人
	*/
	@Column(columnName="c_bhr",dataType="char",dataLength=20,nullAble="Y",comment="被害人")
	...
	* V_SWQK 伤亡情况
	*/
	@Column(columnName="v_swqk",dataType="varchar",dataLength=20,nullAble="Y",comment="伤亡情况")
	...
	* PK_GS_BHR_B 子表主键
	*/
	@Column(columnName="pk_gs_bhr_b",dataType="char",dataLength=20,nullAble="N",comment="子表主键")
	private String PK_GS_BHR_B = "pk_gs_bhr_b";
	/**
	* PK_GS_H 公诉信息主表_主键
	*/
	...
	* getPk_gs_bhr_b(void) 
	*/
	public String getPk_gs_bhr_b(){
		return this.PK_GS_BHR_B;
	}
	/**
	*setPk_gs_bhr_b(java.lang.String)
	*/
	public void setPk_gs_bhr_b(String pk_gs_bhr_b){
		this.PK_GS_BHR_B=pk_gs_bhr_b;
	}
	/**
	* getPk_gs_h(void) 
	*/
