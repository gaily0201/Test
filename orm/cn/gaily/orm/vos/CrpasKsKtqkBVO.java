...
/**
 * <p>Title: CrpasKsKtqkBVO</P>
 * <p>Description: </p>
 * @author xiaoh
 * @version 1.0
 * @since 
 */
@Table(tableName="crpas_ks_ktqk_b")
public class CrpasKsKtqkBVO {
	/**
	* PK_KS_KTQK_B 子表主键
	*/
	@Column(columnName="pk_ks_ktqk_b",dataType="char",dataLength=20,nullAble="N",comment="子表主键")
	private String PK_KS_KTQK_B = "pk_ks_ktqk_b";
	/**
	* VROWNO 行号
	*/
	...
	*/
	@Column(columnName="v_jjjxbhhdl",dataType="varchar",dataLength=200,nullAble="Y",comment="拒绝继续辩护或代理")
	private String V_JJJXBHHDL = "v_jjjxbhhdl";
	/**
	* V_DWXC 对外宣传
	*/
	@Column(columnName="v_dwxc",dataType="varchar",dataLength=200,nullAble="Y",comment="对外宣传")
	...
	* V_BL 笔录
	*/
	@Column(columnName="v_bl",dataType="varchar",dataLength=200,nullAble="Y",comment="笔录")
	private String V_BL = "v_bl";
	/**
	* V_TZCJQK 听证裁决情况
	*/
	@Column(columnName="v_tzcjqk",dataType="varchar",dataLength=200,nullAble="Y",comment="听证裁决情况")
	...
	*/
	...
	/**
	* getPk_ks_ktqk_b(void) 
	*/
	public String getPk_ks_ktqk_b(){
		return this.PK_KS_KTQK_B;
	}
	/**
	*setPk_ks_ktqk_b(java.lang.String)
	*/
	public void setPk_ks_ktqk_b(String pk_ks_ktqk_b){
		this.PK_KS_KTQK_B=pk_ks_ktqk_b;
	}
	/**
	* getVrowno(void) 
	*/
