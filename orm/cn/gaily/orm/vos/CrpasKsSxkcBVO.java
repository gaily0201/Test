...
/**
 * <p>Title: CrpasKsSxkcBVO</P>
 * <p>Description: </p>
 * @author xiaoh
 * @version 1.0
 * @since 
 */
@Table(tableName="crpas_ks_sxkc_b")
public class CrpasKsSxkcBVO {
	/**
	* PK_KS_SXKC_B 子表主键
	*/
	@Column(columnName="pk_ks_sxkc_b",dataType="char",dataLength=20,nullAble="N",comment="子表主键")
	private String PK_KS_SXKC_B = "pk_ks_sxkc_b";
	/**
	* VROWNO 行号
	*/
	...
	* V_QTSY 其他事由
	*/
	@Column(columnName="v_qtsy",dataType="varchar",dataLength=200,nullAble="Y",comment="其他事由")
	...
	* V_XGWS 相关文书
	*/
	@Column(columnName="v_xgws",dataType="varchar",dataLength=50,nullAble="Y",comment="相关文书")
	...
	*/
	...
	/**
	* getPk_ks_sxkc_b(void) 
	*/
	public String getPk_ks_sxkc_b(){
		return this.PK_KS_SXKC_B;
	}
	/**
	*setPk_ks_sxkc_b(java.lang.String)
	*/
	public void setPk_ks_sxkc_b(String pk_ks_sxkc_b){
		this.PK_KS_SXKC_B=pk_ks_sxkc_b;
	}
	/**
	* getVrowno(void) 
	*/
