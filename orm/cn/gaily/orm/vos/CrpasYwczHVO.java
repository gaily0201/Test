...
/**
 * <p>Title: CrpasYwczHVO</P>
 * <p>Description: </p>
 * @author xiaoh
 * @version 1.0
 * @since 
 */
@Table(tableName="crpas_ywcz_h")
public class CrpasYwczHVO {
	/**
	* CREATIONTIME 创建时间
	*/
	...
	* PK_YWCZ_H 主键
	*/
	@Column(columnName="pk_ywcz_h",dataType="char",dataLength=20,nullAble="N",comment="主键")
	private String PK_YWCZ_H = "pk_ywcz_h";
	/**
	* V_CZMC 参照名称
	*/
	@Column(columnName="v_czmc",dataType="varchar",dataLength=50,nullAble="Y",comment="参照名称")
	private String V_CZMC = "v_czmc";
	/**
	* C_SJCZ 上级参照id
	*/
	@Column(columnName="c_sjcz",dataType="char",dataLength=20,nullAble="Y",comment="上级参照id")
	private String C_SJCZ = "c_sjcz";
	/**
	* V_CZBM 参照编码
	*/
	@Column(columnName="v_czbm",dataType="varchar",dataLength=50,nullAble="Y",comment="参照编码")
	private String V_CZBM = "v_czbm";
	/**
	* B_SFQY 是否启用
	*/
	@Column(columnName="b_sfqy",dataType="char",dataLength=1,nullAble="Y",comment="是否启用")
	private String B_SFQY = "b_sfqy";
	/**
	* TRANSTYPE 交易类型
	*/
	...
	* getV_czmc(void) 
	*/
	public String getV_czmc(){
		return this.V_CZMC;
	}
	/**
	*setV_czmc(java.lang.String)
	*/
	public void setV_czmc(String v_czmc){
		this.V_CZMC=v_czmc;
	}
	/**
	* getC_sjcz(void) 
	*/
	public String getC_sjcz(){
		return this.C_SJCZ;
	}
	/**
	*setC_sjcz(java.lang.String)
	*/
	public void setC_sjcz(String c_sjcz){
		this.C_SJCZ=c_sjcz;
	}
	/**
	* getV_czbm(void) 
	*/
	public String getV_czbm(){
		return this.V_CZBM;
	}
	/**
	*setV_czbm(java.lang.String)
	*/
	public void setV_czbm(String v_czbm){
		this.V_CZBM=v_czbm;
	}
	/**
	* getB_sfqy(void) 
	*/
	public String getB_sfqy(){
		return this.B_SFQY;
	}
	/**
	*setB_sfqy(java.lang.String)
	*/
	public void setB_sfqy(String b_sfqy){
		this.B_SFQY=b_sfqy;
	}
	/**
	* getTranstype(void) 
