...
public class CrpasGsHVO {
	...
	* PK_GS_H 主键
	*/
	@Column(columnName="pk_gs_h",dataType="char",dataLength=20,nullAble="N",comment="主键")
	...
	* V_JCY_QSSH 起诉书号
	*/
	@Column(columnName="v_jcy_qssh",dataType="varchar",dataLength=100,nullAble="Y",comment="起诉书号")
	...
	* T_FY_SLSJ 受理时间
	*/
	@Column(columnName="t_fy_slsj",dataType="char",dataLength=19,nullAble="Y",comment="受理时间")
	...
	* C_FY_QSZZM 起诉主罪名ID
	*/
	@Column(columnName="c_fy_qszzm",dataType="varchar",dataLength=20,nullAble="Y",comment="起诉主罪名ID")
	...
	*/
	...
	/**
	* V_JCY_AJBS 检察院案件的唯一标识
	*/
	@Column(columnName="v_jcy_ajbs",dataType="varchar",dataLength=200,nullAble="Y",comment="检察院案件的唯一标识")
	private String V_JCY_AJBS = "v_jcy_ajbs";
	/**
	* C_JCY_YSDW 移送法院ID
	*/
	@Column(columnName="c_jcy_ysdw",dataType="varchar",dataLength=20,nullAble="Y",comment="移送法院ID")
	private String C_JCY_YSDW = "c_jcy_ysdw";
	/**
	* V_FY_SAJZCL 随案卷宗材料
	*/
	@Column(columnName="v_fy_sajzcl",dataType="varchar",dataLength=200,nullAble="Y",comment="随案卷宗材料")
	...
	* V_JCY_YSDWMC 移送法院名称
	*/
	@Column(columnName="v_jcy_ysdwmc",dataType="varchar",dataLength=100,nullAble="Y",comment="移送法院名称")
	private String V_JCY_YSDWMC = "v_jcy_ysdwmc";
	/**
	* C_FY_SCYJ 审查意见
	*/
	@Column(columnName="c_fy_scyj",dataType="varchar",dataLength=20,nullAble="Y",comment="审查意见")
	...
	* C_FY_SPYJ 审批意见
	*/
	@Column(columnName="c_fy_spyj",dataType="varchar",dataLength=20,nullAble="Y",comment="审批意见")
	...
	* V_FY_CBBMMC 承办审判庭名称
	*/
	@Column(columnName="v_fy_cbbmmc",dataType="varchar",dataLength=50,nullAble="Y",comment="承办审判庭名称")
	...
	* C_FY_GXYJ 管辖依据
	*/
	@Column(columnName="c_fy_gxyj",dataType="varchar",dataLength=20,nullAble="Y",comment="管辖依据")
	private String C_FY_GXYJ = "c_fy_gxyj";
	/**
	* V_TQZJJH 庭前证据交换
	*/
	@Column(columnName="v_tqzjjh",dataType="char",dataLength=1,nullAble="Y",comment="庭前证据交换")
	private String V_TQZJJH = "v_tqzjjh";
	/**
	* V_FYSJDQZJ 法院收集调取证据
	*/
	@Column(columnName="v_fysjdqzj",dataType="char",dataLength=1,nullAble="Y",comment="法院收集调取证据")
	...
	* V_AJDXYY 案件大小影响
	*/
	@Column(columnName="v_ajdxyy",dataType="varchar",dataLength=20,nullAble="Y",comment="案件大小影响")
	...
	*/
	@Column(columnName="c_fy_tabgrbzayy",dataType="varchar",dataLength=20,nullAble="Y",comment="同案被告人不在案原因")
	...
	* V_FY_CSXYY 超审限原因
	*/
	@Column(columnName="v_fy_csxyy",dataType="varchar",dataLength=200,nullAble="Y",comment="超审限原因")
	...
	* C_BYSLYY 不予受理原因
	*/
	@Column(columnName="c_byslyy",dataType="varchar",dataLength=20,nullAble="Y",comment="不予受理原因")
	private String C_BYSLYY = "c_byslyy";
	/**
	* C_BHZSYY 驳回自诉原因
	*/
	@Column(columnName="c_bhzsyy",dataType="varchar",dataLength=20,nullAble="Y",comment="驳回自诉原因")
	...
	* V_CSCLSY 撤诉处理事由
	*/
	@Column(columnName="v_csclsy",dataType="varchar",dataLength=20,nullAble="Y",comment="撤诉处理事由")
	private String V_CSCLSY = "v_csclsy";
	/**
	* V_JASY 结案事由
	*/
	@Column(columnName="v_jasy",dataType="varchar",dataLength=200,nullAble="Y",comment="结案事由")
	...
	* V_BCZCTG 补充侦查提纲
	*/
	@Column(columnName="v_bczctg",dataType="varchar",dataLength=2000,nullAble="Y",comment="补充侦查提纲")
	private String V_BCZCTG = "v_bczctg";
	/**
	* C_BCZCDW 补充侦查单位
	*/
	@Column(columnName="c_bczcdw",dataType="varchar",dataLength=20,nullAble="Y",comment="补充侦查单位")
	private String C_BCZCDW = "c_bczcdw";
	/**
	* N_BCZCCS 补充侦查次数
	*/
	@Column(columnName="n_bczccs",dataType="int",dataLength=0,nullAble="Y",comment="补充侦查次数")
	private String N_BCZCCS = "n_bczccs";
	/**
	* V_BCZCFKXX 补充侦查反馈信息
	*/
	@Column(columnName="v_bczcfkxx",dataType="varchar",dataLength=2000,nullAble="Y",comment="补充侦查反馈信息")
	private String V_BCZCFKXX = "v_bczcfkxx";
	/**
	* T_BCZCWCSJ 补充侦查完成时间
	*/
	@Column(columnName="t_bczcwcsj",dataType="char",dataLength=19,nullAble="Y",comment="补充侦查完成时间")
	private String T_BCZCWCSJ = "t_bczcwcsj";
	/**
	* C_JCY_ZAYID 主案由ID
	*/
	@Column(columnName="c_jcy_zayid",dataType="varchar",dataLength=20,nullAble="Y",comment="主案由ID")
	private String C_JCY_ZAYID = "c_jcy_zayid";
	/**
	* V_FY_QSZZMID 起诉主罪名名称
	*/
	@Column(columnName="v_fy_qszzmid",dataType="varchar",dataLength=50,nullAble="Y",comment="起诉主罪名名称")
	private String V_FY_QSZZMID = "v_fy_qszzmid";
	/**
	* B_SFTHBCZC 退回补充侦查(第一次)
	*/
	@Column(columnName="b_sfthbczc",dataType="char",dataLength=1,nullAble="Y",comment="退回补充侦查(第一次)")
	private String B_SFTHBCZC = "b_sfthbczc";
	/**
	* B_SFTHBCZC2 退回补充侦查(第二次)
	*/
	@Column(columnName="b_sfthbczc2",dataType="char",dataLength=1,nullAble="Y",comment="退回补充侦查(第二次)")
	private String B_SFTHBCZC2 = "b_sfthbczc2";
	/**
	* V_BCZCTG2 补充侦查提纲(第二次)
	*/
	@Column(columnName="v_bczctg2",dataType="varchar",dataLength=2000,nullAble="Y",comment="补充侦查提纲(第二次)")
	private String V_BCZCTG2 = "v_bczctg2";
	/**
	* C_BCZCDW2 补充侦查单位(第二次)
	*/
	@Column(columnName="c_bczcdw2",dataType="varchar",dataLength=20,nullAble="Y",comment="补充侦查单位(第二次)")
	private String C_BCZCDW2 = "c_bczcdw2";
	/**
	* V_BCZCFKXX2 补充侦查反馈信息(第二次)
	*/
	@Column(columnName="v_bczcfkxx2",dataType="varchar",dataLength=200,nullAble="Y",comment="补充侦查反馈信息(第二次)")
	private String V_BCZCFKXX2 = "v_bczcfkxx2";
	/**
	* T_BCZCWCSJ2 补充侦查完成时间(第二次)
	*/
	@Column(columnName="t_bczcwcsj2",dataType="char",dataLength=19,nullAble="Y",comment="补充侦查完成时间(第二次)")
	private String T_BCZCWCSJ2 = "t_bczcwcsj2";
	/**
	* V_JAAYMC 结案案由名称
	*/
	@Column(columnName="v_jaaymc",dataType="varchar",dataLength=50,nullAble="Y",comment="结案案由名称")
