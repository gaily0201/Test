...
/**
 * <p>Title: CrpasBaosuHVO</P>
 * <p>Description: </p>
 * @author xiaoh
 * @version 1.0
 * @since 
 */
@Table(tableName="crpas_baosu_h")
public class CrpasBaosuHVO {
	/**
	* MODIFIEDTIME 修改时间
	*/
	...
	* PK_BAOSU_H 主键
	*/
	@Column(columnName="pk_baosu_h",dataType="char",dataLength=20,nullAble="N",comment="主键")
	...
	* V_AJBH 公安案件编号
	*/
	@Column(columnName="v_ajbh",dataType="varchar",dataLength=50,nullAble="Y",comment="公安案件编号")
	...
	* V_JCY_SLSJ 检察院受理时间
	*/
	@Column(columnName="v_jcy_slsj",dataType="char",dataLength=19,nullAble="Y",comment="检察院受理时间")
	...
	* C_JCY_SAR 收案人
	*/
	@Column(columnName="c_jcy_sar",dataType="varchar",dataLength=20,nullAble="Y",comment="收案人")
	...
	* C_JCY_FAR 分案人id
	*/
	@Column(columnName="c_jcy_far",dataType="char",dataLength=20,nullAble="Y",comment="分案人id")
	...
	* C_JCY_CBR 承办人id
	*/
	@Column(columnName="c_jcy_cbr",dataType="char",dataLength=20,nullAble="Y",comment="承办人id")
	...
	* C_JCY_SHR 审核人id
	*/
	@Column(columnName="c_jcy_shr",dataType="char",dataLength=20,nullAble="Y",comment="审核人id")
	...
	*/
	@Column(columnName="c_jcy_bsyqshr",dataType="char",dataLength=20,nullAble="Y",comment="报诉延期审核人id")
	...
	* C_JCY_BMFZR 部门负责人id
	*/
	@Column(columnName="c_jcy_bmfzr",dataType="char",dataLength=20,nullAble="Y",comment="部门负责人id")
	...
	* C_JCY_JCZ 检察长id
	*/
	@Column(columnName="c_jcy_jcz",dataType="char",dataLength=20,nullAble="Y",comment="检察长id")
	...
	* T_GAYSSJ 报诉时间
	*/
	@Column(columnName="t_gayssj",dataType="char",dataLength=19,nullAble="Y",comment="报诉时间")
	...
	* V_SQFYXX 申请复议内容
	*/
	@Column(columnName="v_sqfyxx",dataType="varchar",dataLength=2000,nullAble="Y",comment="申请复议内容")
	...
	* V_SQFHXX 申请复核内容
	*/
	@Column(columnName="v_sqfhxx",dataType="varchar",dataLength=2000,nullAble="Y",comment="申请复核内容")
	...
	* V_BCZCTG 补充侦查提纲(第一次)
	*/
	@Column(columnName="v_bczctg",dataType="varchar",dataLength=2000,nullAble="Y",comment="补充侦查提纲(第一次)")
	private String V_BCZCTG = "v_bczctg";
	/**
	* C_BCZCDW 补充侦查单位(第一次)
	*/
	@Column(columnName="c_bczcdw",dataType="varchar",dataLength=20,nullAble="Y",comment="补充侦查单位(第一次)")
	...
	*/
	...
	/**
	* V_BCZCFKXX 补充侦查反馈信息(第一次)
	*/
	@Column(columnName="v_bczcfkxx",dataType="varchar",dataLength=2000,nullAble="Y",comment="补充侦查反馈信息(第一次)")
	private String V_BCZCFKXX = "v_bczcfkxx";
	/**
	* T_BCZCWCSJ 补充侦查完成时间(第一次)
	*/
	@Column(columnName="t_bczcwcsj",dataType="char",dataLength=19,nullAble="Y",comment="补充侦查完成时间(第一次)")
	private String T_BCZCWCSJ = "t_bczcwcsj";
	/**
	* C_BSJG 报诉结果
	*/
	@Column(columnName="c_bsjg",dataType="varchar",dataLength=20,nullAble="Y",comment="报诉结果")
	private String C_BSJG = "c_bsjg";
	/**
	* B_SFTHBCCL 是否退回补充材料
	*/
	...
	*/
	@Column(columnName="v_bczcfkxx2",dataType="varchar",dataLength=2000,nullAble="Y",comment="补充侦查反馈信息(第二次)")
	...
	* getC_bsjg(void) 
	*/
	public String getC_bsjg(){
		return this.C_BSJG;
	}
	/**
	*setC_bsjg(java.lang.String)
	*/
	public void setC_bsjg(String c_bsjg){
		this.C_BSJG=c_bsjg;
	}
	/**
	* getB_sfthbccl(void) 
