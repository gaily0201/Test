...
/**
 * <p>Title: CrpasGsYsqkBVO</P>
 * <p>Description: </p>
 * @author xiaoh
 * @version 1.0
 * @since 
 */
@Table(tableName="crpas_gs_ysqk_b")
public class CrpasGsYsqkBVO {
	/**
	* PK_GS_YSQK_B 子表主键
	*/
	@Column(columnName="pk_gs_ysqk_b",dataType="char",dataLength=20,nullAble="N",comment="子表主键")
	private String PK_GS_YSQK_B = "pk_gs_ysqk_b";
	/**
	* VROWNO 行号
	*/
	...
	*/
	...
	/**
	* getPk_gs_ysqk_b(void) 
	*/
	public String getPk_gs_ysqk_b(){
		return this.PK_GS_YSQK_B;
	}
	/**
	*setPk_gs_ysqk_b(java.lang.String)
	*/
	public void setPk_gs_ysqk_b(String pk_gs_ysqk_b){
		this.PK_GS_YSQK_B=pk_gs_ysqk_b;
	}
	/**
	* getVrowno(void) 
	*/
