...
/**
 * <p>Title: CrpasWsmlglHVO</P>
 * <p>Description: </p>
 * @author xiaoh
 * @version 1.0
 * @since 
 */
@Table(tableName="crpas_wsmlgl_h")
public class CrpasWsmlglHVO {
	/**
	* BILLNO 单据号
	*/
	...
	* N_SHOWNO 显示顺序
	*/
	@Column(columnName="n_showno",dataType="int",dataLength=0,nullAble="Y",comment="显示顺序")
	private String N_SHOWNO = "n_showno";
	/**
	* V_MLLX 目录类型
	*/
	@Column(columnName="v_mllx",dataType="varchar",dataLength=20,nullAble="Y",comment="目录类型")
	private String V_MLLX = "v_mllx";
	/**
	* V_MLBH 目录编号
	*/
	@Column(columnName="v_mlbh",dataType="varchar",dataLength=50,nullAble="Y",comment="目录编号")
	private String V_MLBH = "v_mlbh";
	/**
	* V_MLMC 目录名称
	*/
	@Column(columnName="v_mlmc",dataType="varchar",dataLength=100,nullAble="Y",comment="目录名称")
	private String V_MLMC = "v_mlmc";
	/**
	* V_BZ 备注
	*/
	...
	* getN_showno(void) 
	*/
	public String getN_showno(){
		return this.N_SHOWNO;
	}
	/**
	*setN_showno(java.lang.String)
	*/
	public void setN_showno(String n_showno){
		this.N_SHOWNO=n_showno;
	}
	/**
	* getV_mllx(void) 
	*/
	public String getV_mllx(){
		return this.V_MLLX;
	}
	/**
	*setV_mllx(java.lang.String)
	*/
	public void setV_mllx(String v_mllx){
		this.V_MLLX=v_mllx;
	}
	/**
	* getV_mlbh(void) 
	*/
	public String getV_mlbh(){
		return this.V_MLBH;
	}
	/**
	*setV_mlbh(java.lang.String)
	*/
	public void setV_mlbh(String v_mlbh){
		this.V_MLBH=v_mlbh;
	}
	/**
	* getV_mlmc(void) 
	*/
	public String getV_mlmc(){
		return this.V_MLMC;
	}
	/**
	*setV_mlmc(java.lang.String)
	*/
	public void setV_mlmc(String v_mlmc){
		this.V_MLMC=v_mlmc;
	}
	/**
	* getV_bz(void) 
