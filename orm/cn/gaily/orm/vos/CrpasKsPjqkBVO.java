...
/**
 * <p>Title: CrpasKsPjqkBVO</P>
 * <p>Description: </p>
 * @author xiaoh
 * @version 1.0
 * @since 
 */
@Table(tableName="crpas_ks_pjqk_b")
public class CrpasKsPjqkBVO {
	/**
	* PK_KS_PJQK_B 子表主键
	*/
	@Column(columnName="pk_ks_pjqk_b",dataType="char",dataLength=20,nullAble="N",comment="子表主键")
	private String PK_KS_PJQK_B = "pk_ks_pjqk_b";
	/**
	* VROWNO 行号
	*/
	...
	*/
	@Column(columnName="v_jchbgqzcs",dataType="varchar",dataLength=200,nullAble="Y",comment="解除或变更强制措施")
	private String V_JCHBGQZCS = "v_jchbgqzcs";
	/**
	* V_BKZKWCL 被扣赃款物处理
	*/
	@Column(columnName="v_bkzkwcl",dataType="varchar",dataLength=200,nullAble="Y",comment="被扣赃款物处理")
	...
	* V_QTCWCL 其它财物处理
	*/
	@Column(columnName="v_qtcwcl",dataType="varchar",dataLength=200,nullAble="Y",comment="其它财物处理")
	...
	* V_GPYY 改判原因
	*/
	@Column(columnName="v_gpyy",dataType="varchar",dataLength=200,nullAble="Y",comment="改判原因")
	...
	*/
	...
	/**
	* getPk_ks_pjqk_b(void) 
	*/
	public String getPk_ks_pjqk_b(){
		return this.PK_KS_PJQK_B;
	}
	/**
	*setPk_ks_pjqk_b(java.lang.String)
	*/
	public void setPk_ks_pjqk_b(String pk_ks_pjqk_b){
		this.PK_KS_PJQK_B=pk_ks_pjqk_b;
	}
	/**
	* getVrowno(void) 
	*/
